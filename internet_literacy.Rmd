...
t.test(temp_after$total_score1[temp_after$treatment == 0], 
       temp_after$total_score2[temp_after$treatment == 0],
       paired=TRUE)
...
```{r}
t.test(temp_after$total_score1[temp_after$treatment == 1], 
       temp_after$total_score2[temp_after$treatment == 1],
       paired=TRUE)
```
...
t.test(temp_after$total_score1[temp_after$treatment == 0 & temp_after$sex == 1], 
       temp_after$total_score2[temp_after$treatment == 0 & temp_after$sex == 1],
       paired=TRUE)
...
```{r}
t.test(temp_after$total_score1[temp_after$treatment == 1 & temp_after$sex == 1], 
       temp_after$total_score2[temp_after$treatment == 1 & temp_after$sex == 1],
       paired=TRUE)
```
...
t.test(temp_after$total_score1[temp_after$treatment == 0 & temp_after$sex == 0], 
       temp_after$total_score2[temp_after$treatment == 0 & temp_after$sex == 0],
       paired=TRUE)
...
```{r}
t.test(temp_after$total_score1[temp_after$treatment == 1 & temp_after$sex == 0], 
       temp_after$total_score2[temp_after$treatment == 1 & temp_after$sex == 0],
       paired=TRUE)
```
